    ...
    <div class="col-md-8">
        <div class="card shadow">
            <div class="card-header bg-warning text-dark">
                <h4><i class="bi bi-pencil"></i> Edit Paket Laundry</h4>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('satuan') is-invalid @enderror" 
                                    ...
                                    <option value="kg" {{ old('satuan', $paket->satuan) == 'kg' ? 'selected' : '' }}>Kilogram (kg)</option>
                                    <option value="pcs" {{ old('satuan', $paket->satuan) == 'pcs' ? 'selected' : '' }}>Pieces (pcs)</option>
                                </select>
                                @error('satuan')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
