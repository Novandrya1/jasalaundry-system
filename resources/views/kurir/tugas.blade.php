                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <h5 class="card-title mb-0">{{ $transaksi->kode_invoice }}</h5>
                                ...
                                <div class="mb-2">
                                    ...
                                    <span>{{ $transaksi->alamat_jemput }}</span>
                                </div>
                                ...
                                <div class="text-md-end">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <a href="https://wa.me/{{ $cleanPhone }}?text={{ urlencode($message) }}" 
                                           target="_blank" class="btn btn-outline-success btn-sm w-100 mt-2">
                                            <i class="bi bi-whatsapp"></i> WhatsApp Pelanggan
                                        </a>
                                        
                                        <!-- Tombol Maps -->
                                        <a href="https://maps.google.com/?q={{ urlencode($transaksi->alamat_jemput) }}" 
                                           target="_blank" class="btn btn-outline-info btn-sm w-100 mt-2">
